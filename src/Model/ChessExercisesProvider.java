...
public class ChessExercisesProvider {
    ...
    private static ChessExercises[] finals={
        new ChessExercises("8/1p6/p1p2kp1/2P1p2p/1P2PP1P/P4K2/8/8 w - - 0 1","difícil","Final de peones",15,"Juegan blancas y ganan"),
        ...
        new ChessExercises("r7/3kb3/6R1/2P2KB1/8/8/8/8 w - - 0 1","difícil","Temas tácticos en el final",6,"Juegan blancas y ganan"),
        new ChessExercises("6k1/5p1p/6p1/2b5/1q1Q4/1N4n1/P3BKP1/8 w - - 1 2","fácil","Clavadas en el final",4,"Juegan negras y ganan"),
        new ChessExercises("8/3b4/3k1q1p/1ppPNp2/7P/8/P1Q3P1/6K1 w - - 0 1","difícil","Sacrificio para ganar material",6,"Juegan blancas y ganan"),
        new ChessExercises("k4q2/n7/B1b5/2N5/8/6Q1/8/6K1 w - - 0 1","difícil","Sacrificio ganador",6,"Juegan blancas y ganan"),
        new ChessExercises("8/6pk/7p/Rrrn4/2N5/2P3P1/R5KP/8 b - - 0 1","difícil","Tenedor para conseguir ventaja",6,"Juegan negras y consiguen ligera ventaja"),
        new ChessExercises("2r5/5kb1/4R3/p2p2p1/1ppP4/2P3P1/PP4BP/6K1 b - - 0 1","difícil","Intermedia ganadora",7,"Juegan negras y ganan")
    ...
    private static ChessExercises[] mates={
        ...
        new ChessExercises("rkn5/pp1R4/2pn4/2N5/8/8/8/K7 w - - 0 1","fácil","Combinación de mate",3,"Mate en dos con blancas!"),
        new ChessExercises("2kr4/pppb3p/5r2/8/1qP2p2/3Q1N2/PP3PPP/2KRR3 w - - 0 1","fácil","Sacrificio ganador",5,"Mate en 3 con blancas!"),
        new ChessExercises("1q3rbk/Q5pp/8/3P4/1r3n2/R3N3/2B2PPP/5RK1 b - - 0 1","intermedio","Jugada intermedia",5,"Mate en 3 con negras!"),
        new ChessExercises("5k2/4q1p1/4p3/3pP2Q/3P2P1/8/2B3K1/8 w - - 0 1","fácil","Mate inevitable",5,"Mate en 3 con blancas!"),
        new ChessExercises("2r3k1/Q1R2p1p/4p1pb/4P3/3P4/5N2/Pr2qPPP/5RK1 b - - 0 1","intermedio","Última fila",9,"Mate en 5 con negras!"),
        ...
        new ChessExercises("r3q2k/pp2Nppp/n7/8/2R4Q/8/PP4PP/6K1 w - - 0 1","fácil","Mate clasico",3,"Juegan blancas y dan mate!"),
        new ChessExercises("1kr5/ppp3QR/qr6/1N6/P7/1P6/2P5/1K3R2 w - - 0 1","intermedio","Sobrecarga",9,"Juegan blancas y dan mate en 3"),
        new ChessExercises("1kbr3r/ppp2n2/4N3/1N6/8/P3B3/1PP3B1/1K6 w - - 0 1","fácil","Tema típico",3,"Juegan blancas y dan mate!")
